...
You **cannot** use wildcard characters (`*`) anywhere when specifying IDs in BetonQuestAddon. All targets must be written out with their exact, full ID names.
:::
...
**Example:** `customFishingCaughtFish stone amount:1 isCancelled:true`
:::
